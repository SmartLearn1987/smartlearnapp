      ...
      <div className="bg-white border-b border-border/50 px-4 sm:px-8 py-3 flex items-center justify-between shadow-sm z-10 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
             ...
             <div>
               <h1 className="font-heading text-lg font-black leading-none">Vua Tiếng Việt</h1>
        ...
        <div className="flex items-center gap-3 sm:gap-6">
           ...
           <Button onClick={handleFinish} className="rounded-2xl h-11 px-8 font-black uppercase tracking-wider bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-200">
             Kết thúc
           </Button>
        </div>
      </div>

      <div className="flex-1 flex flex-col lg:flex-row gap-6 p-4 sm:p-8 min-h-0 container max-w-7xl mx-auto">
         {/* Main Game Area */}
         <div className="flex-1 flex flex-col gap-6 min-h-0 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Question Card */}
            <div className="flex-1 min-h-0 bg-white rounded-[3rem] border-2 border-border/50 shadow-xl shadow-muted/50 flex flex-col relative overflow-hidden group">
               <div className="absolute top-8 left-8 flex items-center gap-3 z-10">
                  <span className="px-4 py-1.5 rounded-2xl bg-emerald-600 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-200">
                    Thử thách {currentIdx + 1}
                  </span>
                  <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-muted/50 border border-border/40 text-muted-foreground">
                  ...
                  <div className="w-full max-w-2xl text-center space-y-6">
                     ...
                     <div className="relative pt-2 group/input">
                        <input
                          ...
                          className={`w-full h-20 px-8 text-center text-2xl sm:text-3xl font-black rounded-[2rem] border-4 transition-all uppercase tracking-widest
                            ${hasChecked 
                                ? isCorrect 
                        ...
                        <div className="flex justify-center gap-3 mt-6">
                           <Button 
                             ...
                             className={`h-14 px-10 rounded-2xl font-black uppercase tracking-wider transition-all
                               ${hasChecked 
                                 ? isCorrect 
                             ...
                             `}
                           >
                              {hasChecked ? (isCorrect ? <CheckCircle2 className="mr-2 h-5 w-5" /> : <X className="mr-2 h-5 w-5" />) : <Check className="mr-2 h-5 w-5" />}
                           ...
                           <Button 
                             ...
                             disabled={!q.hint}
                             className={`h-14 px-8 rounded-2xl border-2 font-black uppercase tracking-wider transition-all
         ...
         <div className="w-full lg:w-[320px] shrink-0 flex flex-col gap-6">
            <div className="bg-white border-2 border-border/50 rounded-[2.5rem] p-6 shadow-xl shadow-muted/50 flex flex-col flex-1 min-h-0">
               ...
               <div className="grid grid-cols-5 sm:grid-cols-10 lg:grid-cols-5 gap-2 overflow-y-auto pr-1 flex-1 custom-scrollbar min-h-0">
                 {questions.map((_, idx) => {
